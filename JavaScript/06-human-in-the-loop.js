...
const initialPrompt = "Navigate to a homepage and take a screenshot.";
const systemPrompt = "You are a web navigation assistant. When you dont know something DO NOT stop or make assumption, ASK the user for feedback so we can continue";
